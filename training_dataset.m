...
for i=1:8
        ...
        for j=1:3
            ...
            for k=1:256:2048
                ...
                [M,I]= max(P1);
                beat_frequency=f(I);
                matriz=[pw_AC/57017000 zcdOut/596 beat_frequency/108 desvio/7553 psd_desvio/149030 str2num(nome_da_pasta)/100];
                dlmwrite('dataset_training.CSV',matriz,'-append');
            end
        end 
end
...
for i=1:8
        ...
        for j=4:5
            ...
            for k=1:256:2048
                ...
                beat_frequency=f(I);
                matriz=[pw_AC/57017000 zcdOut/596 beat_frequency/108 desvio/7553 psd_desvio/149030 str2num(nome_da_pasta)/100];
                dlmwrite('dataset_testing.CSV',matriz,'-append');
            end
        end 
end        
